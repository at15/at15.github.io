...
% TODO: Split into two sections X-Ray and CloudWatch Agent
% TODO: W3C, lead team of ? engineers?
\datedsubsection{\textbf{AWS}: Software Engineer - AWS X-Ray}{Vancouver, Canada \quad Sep 2020 - Present \quad}
\begin{itemize}
	\item Enhanced API scalability and reduced latency for \href{https://aws.amazon.com/xray/}{AWS X-Ray}, a distributed tracing service.
	\item Contributed to the open source \href{https://github.com/aws/amazon-cloudwatch-agent}{CloudWatch Agent} and \href{https://github.com/aws-observability/aws-otel-collector}{OpenTelemetry Collector}.
\end{itemize}
...
\begin{itemize}
	\item Developed gRPC server and client in Go and Python, backed by Spanner, deployed on Borg and Kuberentes.
	\item Improved reliability of custom batch job controller for Kuberentes, eliminating job lost during controller service restart.
	% TODO: How? I kind of forgot ... it's been too long
	\item Reduced startup latency of debug session from 2 minutes to 40 seconds.
...
\begin{flushleft}
	\begin{tabular}{@{}ll@{}}
		Language  & Go, Java, JavaScript, Python, Rust, C++, SQL                                                  \\
		Database  & DynamoDB, Cassandra, MySQL, Elasticsearch, Redis, Prometheus \\
