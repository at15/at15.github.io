...
\datedsubsection{\textbf{PayPal}: Software Engineer 2 - Container Orchestration system in Go}{San Jose, CA \quad May 2018 - Present \quad}
\begin{itemize}
	% \itemsep0em
	\item Working on internal multi data center container orchestration platform using Apache Mesos, Aurora and Docker.
...
\datedsubsection{\textbf{Distributed database benchmark framework} \quad \href{https://github.com/benchhub}{github.com/benchhub}}{UCSC \quad Nov. 2017 -- March. 2018}
...
\begin{flushleft}
	\begin{tabular}{@{}ll@{}}
		...
		Framework & Angular, Vue, Laravel, Spring, Dropwizard, Express, Rails, CUDA, Hadoop
	\end{tabular}
\end{flushleft}
