...
\begin{itemize}
	\item Working on AWS X-Ray \href{https://aws.amazon.com/xray/}, a distributed tracing service, improve API scalability and reduce latency.
	\item Worked on the open source \href{https://github.com/aws/amazon-cloudwatch-agent}{CloudWatch Agent} and \href{https://github.com/aws-observability/aws-otel-collector}{OpenTelemetry Collector}.
\end{itemize}
