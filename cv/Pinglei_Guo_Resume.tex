...
\datedsubsection{\textbf{PayPal}: Software Engineer 2}{San Jose, CA \quad May 2018 - Present \quad}
\begin{itemize}
	% \itemsep0em
	\item Working on internal container orchestration platform using Mesos, Aurora and Docker.
\end{itemize}
...
\datedsubsection{\textbf{Distributed database benchmark framework} \quad \href{https://github.com/benchhub}{github.com/benchhub}}{UCSC \quad Nov. 2017 -- Present}
