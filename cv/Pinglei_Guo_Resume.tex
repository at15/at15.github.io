...
\begin{itemize}
\item API gateway for microservice using Golang. Deployed in QA on Mesos using Docker with horizontal scale
\item Admin Dashboard using Angular 4, Semantic UI and TypeScript for internal container orchestration platform
\item Full text search using Apache Solr, open sourced a new Golang client with better performance and interface
\end{itemize}

\datedsubsection{GitCafe: \textbf{Software Engineer Intern}}{Shanghai, China \textit{Jan. 2015 -- Mar. 2015}}
\begin{itemize}
\item Web application using Ruby on Rails and AngularJS. Full text search using Elasticsearch.
...
\datedsubsection{Dongyue Web Studio: Full stack web developer \& Tech lead}{Shanghai, China \textit{Sep. 2013 -- Jan. 2016}}
\begin{itemize}
